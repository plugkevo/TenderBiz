...
class UpdateTendersAdapter(private val tenderList: List<Tender>):
    RecyclerView.Adapter<UpdateTendersAdapter.TenderViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TenderViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, UpdateTenderDetails::class.java)
            intent.putExtra("TENDER_ID", tender.id)
